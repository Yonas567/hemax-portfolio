...
import { ArrowRight, ExternalLink, CheckCircle, Award, TrendingUp, BarChart } from "lucide-react"
  ...
  const portfolioItems = [
    {
      ...
      description: "Complete digital rebrand and SEO strategy that increased organic traffic by 150% in 6 months.",
      image: "/placeholder.svg?height=600&width=800",
      results: ["150% increase in organic traffic", "200% increase in lead generation", "45% reduction in bounce rate"],
    },
    {
      title: "Retail Innovations Campaign",
      category: "Social Media Marketing",
      description: "Strategic social media campaign across multiple platforms that boosted engagement and sales.",
      image: "/placeholder.svg?height=600&width=800",
      results: ["300% increase in social engagement", "25% increase in online sales", "45,000 new followers"],
    },
    {
      title: "Growth Ventures PPC",
      category: "PPC Advertising",
      description: "Targeted PPC campaign that significantly reduced cost per acquisition and increased ROI.",
      image: "/placeholder.svg?height=600&width=800",
      results: ["40% reduction in cost per acquisition", "85% increase in conversion rate", "120% increase in ROI"],
    },
    {
      title: "EcoFriendly Email Campaign",
      category: "Email Marketing",
      description: "Personalized email marketing strategy that revitalized customer engagement and boosted sales.",
      image: "/placeholder.svg?height=600&width=800",
      results: ["45% open rate (industry avg: 20%)", "12% click-through rate", "35% increase in repeat purchases"],
    },
    {
      title: "Luxury Brand Website",
      category: "Web Design & Development",
      description: "Premium e-commerce website with seamless UX that elevated the brand and increased conversions.",
      image: "/placeholder.svg?height=600&width=800",
      results: [
    ...
    },
    {
      ...
      description: "Comprehensive content strategy that established the client as an industry thought leader.",
      image: "/placeholder.svg?height=600&width=800",
      results: ["250% increase in blog traffic", "35 high-quality backlinks generated", "15 media mentions"],
    },
  ]
          ...
          <ScrollReveal>
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-zinc-400">
                Explore our case studies and discover how we've helped businesses achieve their digital marketing goals.
              </p>
            </div>
          </ScrollReveal>
        </div>
            ...
            {[
              {
                ...
                icon: <TrendingUp className="h-8 w-8 text-purple-500 mx-auto mb-4" />,
              },
              {
                value: 85,
                suffix: "%",
                label: "Conversion Rate Improvement",
                icon: <BarChart className="h-8 w-8 text-pink-500 mx-auto mb-4" />,
              },
              {
                value: 40,
                suffix: "%",
                label: "Cost Per Acquisition Reduction",
                icon: <Award className="h-8 w-8 text-purple-500 mx-auto mb-4" />,
              },
              {
                value: 200,
                suffix: "+",
                label: "Successful Projects",
                icon: <CheckCircle className="h-8 w-8 text-pink-500 mx-auto mb-4" />,
              },
            ].map((stat, index) => (
        ...
        <div className="container px-4 md:px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-zinc-400 max-w-2xl mx-auto">
                Explore how we've helped businesses across various industries achieve their goals
              </p>
            </div>
          </ScrollReveal>
      ...
      <ParallaxSection>
        <section className="py-20 bg-black">
          <div className="container px-4 md:px-6">
            <ScrollReveal>
              <div className="text-center mb-16">
                <h2 className="text-3xl font-bold mb-4">Success Story Spotlight</h2>
                <p className="text-zinc-400 max-w-2xl mx-auto">
                  A closer look at one of our most successful client partnerships
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <ScrollReveal direction="right">
                <div className="space-y-6">
                  ...
                  <h3 className="text-2xl font-bold">LuxuryGoods Online Store</h3>
                  <p className="text-zinc-400">
                    LuxuryGoods came to us with a beautiful product line but struggling online sales. Their website
                    wasn't converting visitors, and their digital marketing efforts weren't reaching the right audience.
                  </p>

                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-purple-400 mb-2">The Challenge</h4>
                      <p className="text-zinc-300">
                        Low conversion rate (1.2%), high cart abandonment (78%), and ineffective ad spend with poor
                        targeting.
                      </p>
                    </div>

                    <div>
                      <h4 className="font-semibold text-purple-400 mb-2">Our Solution</h4>
                      <p className="text-zinc-300">
                        Complete website redesign with UX optimization, targeted PPC campaigns, and email marketing
                        automation for abandoned carts.
                      </p>
                    </div>

                    <div>
                      <h4 className="font-semibold text-purple-400 mb-2">The Results</h4>
                      <ul className="space-y-1">
                        <li className="flex items-start gap-2 text-sm">
                          <CheckCircle className="h-4 w-4 text-purple-500 shrink-0 mt-0.5" />
                          <span className="text-zinc-300">320% increase in conversion rate</span>
                        </li>
                        <li className="flex items-start gap-2 text-sm">
                          <CheckCircle className="h-4 w-4 text-purple-500 shrink-0 mt-0.5" />
                          <span className="text-zinc-300">45% reduction in cart abandonment</span>
                        </li>
                        <li className="flex items-start gap-2 text-sm">
                          <CheckCircle className="h-4 w-4 text-purple-500 shrink-0 mt-0.5" />
                          <span className="text-zinc-300">215% increase in ROAS (Return on Ad Spend)</span>
                        </li>
                      </ul>
                    </div>
                  </div>
        ...
        <div className="container px-4 md:px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-zinc-400 max-w-2xl mx-auto">What our clients say about working with us</p>
            </div>
          </ScrollReveal>
            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="text-zinc-200 mb-8">
                  Let's discuss how we can help your business achieve similar results with our tailored digital
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 hover:bg-white/15 transition-colors">
                  ...
                  <p className="text-zinc-300 text-sm">
                    Explore our extended portfolio with detailed case studies and results.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 hover:bg-white/15 transition-colors">
                  <div className="flex items-center gap-2 mb-2">
                    <ExternalLink className="h-5 w-5 text-purple-400" />
                    <h3 className="font-semibold">Download Our Capabilities Deck</h3>
                  </div>
                  <p className="text-zinc-300 text-sm">Get a comprehensive overview of our services and expertise.</p>
                </div>
              </div>
            </ScrollReveal>
          </div>
